...
public class WriterClassOrderVO {
	
	private Integer rownum;
	private Integer class_order_seq;
	private String class_order_code;
	private Integer class_order_price;
	private Date class_order_date;
	private Timestamp class_order_time;
	private Integer class_order_donation;
	private String class_order_id;
	private Integer class_order_people;
	private String class_order_demand;
	private boolean class_payment_check;
	private Timestamp class_payment_date;
	private Integer class_order_review;
	...
	public String getClass_order_title() {
		return class_order_title;
	}
	public void setClass_order_title(String class_order_title) {
		this.class_order_title = class_order_title;
	}
	...
	public Integer getClass_order_seq() {
		return class_order_seq;
	}
	public void setClass_order_seq(Integer class_order_seq) {
	...
	public Integer getClass_order_price() {
		return class_order_price;
	}
	public void setClass_order_price(Integer class_order_price) {
	...
	public Timestamp getClass_order_time() {
		return class_order_time;
	}
	public void setClass_order_time(Timestamp class_order_time) {
		this.class_order_time = class_order_time;
	}
	public Integer getClass_order_donation() {
		return class_order_donation;
	}
	public void setClass_order_donation(Integer class_order_donation) {
	...
	public Integer getClass_order_people() {
		return class_order_people;
	}
	public void setClass_order_people(Integer class_order_people) {
	...
	public Integer getClass_order_review() {
		return class_order_review;
	}
	public void setClass_order_review(Integer class_order_review) {
	...
	public Integer getClass_seller_code() {
		return class_seller_code;
	}
