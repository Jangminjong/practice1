...
public class SellerProductReviewVO {
	...
	public Date getGoods_review_date() {
		return goods_review_date;
	}
	public void setGoods_review_date(Date goods_review_date) {
	...
	public String toString() {
		return "SellerProductReviewVO [goods_review_seq=" + goods_review_seq + ", goods_review_id=" + goods_review_id
				+ ", goods_review_code=" + goods_review_code + ", goods_review_date=" + goods_review_date
				+ ", goods_review_point=" + goods_review_point + ", goods_review_image="
				+ Arrays.toString(goods_review_image) + ", goods_review_option1=" + goods_review_option1
				+ ", goods_review_option2=" + goods_review_option2 + ", goods_review_option3=" + goods_review_option3
				+ ", goods_review_context=" + goods_review_context + "]";
	}
}
