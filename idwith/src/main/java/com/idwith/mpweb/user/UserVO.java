...
public class UserVO {
	...
	private boolean order_save_true;
	...
	public boolean isOrder_save_true() {
		return order_save_true;
	}

	public void setOrder_save_true(boolean order_save_true) {
		this.order_save_true = order_save_true;
	}
