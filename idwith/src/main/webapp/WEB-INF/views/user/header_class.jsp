					...
					<c:choose>
						<c:when test="${ emailSplit eq null }">
							<nav class="fr" style="margin-left: 700px;">
								...
								<a id="gnb-login-button" href="login.do" class="nav-btn"
									data-log-object="login">로그인</a> <a href="sign_choice.do"
									class="nav-btn" data-log-object="member_join">회원가입</a> <a
									href="board.do" class="nav-btn"
									data-log-object="member__notice">공지사항</a> <a href="board.do"
									class="nav-btn" data-log-object="member_qna">1:1문의</a>
						...
						<c:when test="${ emailSplit ne null }">
							<nav class="fr" style="margin-left: 55%;">
								...
								<div class="nav-btn ui-dropdown message message-list"
									id="message-list-alarm" onmouseover="alarmView()">
									...
									<div class="menu-dropdown menu-second alarm"
										style="width: 360px; margin-left: -160px;">
										...
										<ul
												...
												<c:forEach var="event" items="${event}">
													<div class="notification_card_container">
														<input type="hidden" name="paging_param"> <a
															...
															class="notification_card_link alarm-card-link">
															<div>
																<img src="resources/images/title/icon_300.PNG"
																	class="notification_card_artist_img mCS_img_loaded alarm-logo">
															</div>
															<div class="notification_card_content_box alarm-box">
																<p class="label"
																	style="font-weight: bold; color: #ff7b30;">이벤트</p>
											...
											<a data-log-noti-object="see_all" href="alarm.do"
												class="dropdown-link-style link-style">모두 보기</a>
										</ul>
									</div>
								</div>
								<div class="nav-btn ui-dropdown message message-list"
									id="message-list-msg" onmouseover="messageView()">
									<button type="button" class="btn-dropdown btn-third"
										data-ui="load-message-btn">
										<i class="fa fa-commenting-o" aria-hidden="true"></i> <span
											class="title">메시지</span>
									</button>
									<div class="menu-dropdown menu-third message"
										...
										<ul
											...
											<a data-log-noti-object="see_all" href="message.do"
												class="dropdown-link-style link-style">모두 보기</a>
										</ul>
									</div>
								</div>

								<a href="eventNoticeBoard.do" class="nav-btn"
									data-log-object="member__notice">공지사항</a> <a href="board.do"
									class="nav-btn" data-log-object="member_qna">1:1문의</a>
