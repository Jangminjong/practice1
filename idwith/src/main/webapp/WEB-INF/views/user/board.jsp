	...
	<div class="wrap">
		...
		<div id="content" class="content" data-gnb-show="true">
			...
			<div class="inner-w mobile-full">
				<nav class="cnn-list">
					<a href="/w/board/notice/detail?id=442">
						<div>
					...
					</a> <a href="/w/board/notice/detail?id=439">
						<div>
					...
					</a> <a href="/w/board/notice/detail?id=438">
						<div>
							<span style="color: red;"></span> ❑ <strong><span
								style="color: #000000;">[EVENT]&nbsp;</span>9월줍줍 신청만 해도 1만원 쿠폰
								발급!💌</strong>&nbsp;쿠폰 받고 추석 맞이하자
						</div>
					</a> <a href="/w/board/notice/detail?id=443">
						<div>
					...
					</a> <a href="/w/board/notice/detail?id=444">
						<div>
					...
					</a> <a href="/w/board/notice/detail?id=370">
						<div>
							<span style="color: red;"></span> ❑ <span
