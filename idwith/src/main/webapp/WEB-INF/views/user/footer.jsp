	...
	<footer id="footer" class="footer">
		...
		<div class="inner-w clf" data-has-inquire-btn="false">
			<div class="logo-footer fl">
				...
				<img src="resources/images/logo.PNG" class="idus_logo">			
			</div>
			...
			<div class="text-box fr">
				...
				<nav class="sns-list">
					...
					<a href="https://www.instagram.com/idus.me/" target="blank">
						<!--  class="sp-icon icon-instagram-c"-->
						<img src="resources/images/instagram.PNG" />
					</a> 
					<a href="https://blog.naver.com/idus_me" target="blank" >
						<!--  class="sp-icon icon-blog" -->
						<img src="resources/images/naverBlog.PNG" />
					</a> 
					...
					<a href="https://twitter.com/IDus_kr" target="blank" >
				...
				<div class="escrow">
					...
					<div class="clf">
						...
						<img src="resources/images/safe.PNG" class="safe_icon">
