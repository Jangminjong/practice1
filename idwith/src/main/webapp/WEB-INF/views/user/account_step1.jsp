...
<meta property="og:description"
	content="취향 맞춤 작품 구매부터 취미 생활까지, 아이디어스로 일상에 특별함을 잇다!" />
<meta property="og:url" content="http://idus.com/w/reauth/step1" />
<meta property="og:image"
	content="http://idus.com/resources/dist/images/ogimg-idus.png?ver=2.0" />
<link rel="canonical" href="http://idus.com/w/reauth/step1" />
<script>
...
<body>
					...
					<form data-form="reauth" action="account_step2.do"
						...
						<fieldset class="login input-group">
							<label class="userinput--boxed"> <input
								...
								value="wnguddlgh11@na***"> <em class="userinput__label">wnguddlgh11@na***</em>
							</label> <label class="userinput--boxed"> <input
								class="userinput__input--checkbox" type="radio" name="answer"
								value="jungsin886@na***"> <em class="userinput__label">jungsin886@na***</em>
							</label>
						</fieldset>
    ...
    (function () {
        ...
        Logger.sendPageView(PageName.ReauthStep1, {
