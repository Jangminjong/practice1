	...
	<section class="artist-contents">
		...
		<c:choose>
			<c:when test="${empty list}">
					<div class="empty-data" style="margin: 100px;">
						<i class="fa fa-exclamation" aria-hidden="true"></i> 작가님의 리뷰가 없습니다.
					</div>
			</c:when>
			<c:when test="${!empty list}">
					...
					<div data-v-630eb5b4="" class="artist-review-list">
						<div data-v-630eb5b4="" style="display: flex; margin-left: -16px;">
							<div class=""
								...
								<c:forEach var="reviewList" items="${list}" end="${listLength}">
									<li data-v-e6011578="" data-v-630eb5b4=""
										...
										data-logging="artist_purchase_review"><div
												...
												<div data-v-e6011578="" class="review-info">
													...
													<div data-v-e6011578="" class="reviewer-detail-info">
														<span data-v-e6011578="" class="reviewer-name">
															${reviewList.goods_review_id} </span> <span data-v-e6011578=""
															class="review-date">${reviewList.goods_review_date}</span>
													</div>
												</div>
											...
											<div data-v-e6011578="" class="review-card__body">${reviewList.goods_review_context}</div>
											<!----></a> <a data-v-e6011578=""
										href="detail_content.do?reviewId=${reviewList.goods_review_id}"
										target="_blank"><div data-v-e6011578=""
												class="product-badge">
												<img data-v-e6011578=""
												...
												<div data-v-e6011578="" class="product-info">
													<span data-v-e6011578="" class="artist-name"> 초은농장 </span>
													<span data-v-e6011578="" class="product-title">
													...
													<div data-v-e6011578="" class="product-price">
														...
														<del data-v-e6011578="" class="origin-price">
															10,000원 </del>
													</div>
												</div>
											</div></a></li>
							...
							<div class=""
								...
								<c:forEach var="reviewLi" items="${list}"
									begin="${listLength+1}">
									<li data-v-e6011578="" data-v-630eb5b4=""
										class="artist-review-card card-style"><input
										data-v-e6011578="" name="next" type="hidden"
										...
										data-logging="artist_purchase_review"><div
												...
												<div data-v-e6011578="" class="review-info">
													...
													<div data-v-e6011578="" class="reviewer-detail-info">
														<span data-v-e6011578="" class="reviewer-name">
															${reviewLi.goods_review_id} </span> <span data-v-e6011578=""
															class="review-date">${reviewLi.goods_review_date}
														</span>
													</div>
												</div>
												<div data-v-e6011578="" class="review-rate">
													<span data-v-ef94db98="" data-v-e6011578="" data-value="5"
														class="ui_rating fr"> <i class="fa fa-star"
														aria-hidden="true" style="color: #f5eb75;"></i> <i
														class="fa fa-star" aria-hidden="true"
														style="color: #f5eb75;"></i> <i class="fa fa-star"
														aria-hidden="true" style="color: #f5eb75;"></i> <i
														class="fa fa-star" aria-hidden="true"
														style="color: #f5eb75;"></i> <i class="fa fa-star"
														aria-hidden="true" style="color: #f5eb75;"></i>
													</span>
												</div>
											</div>
											<div data-v-e6011578="" class="review-card__body">${reviewLi.goods_review_context}</div>
											<!----></a> <a data-v-e6011578="" href="detail_content.do"
										target="_blank"><div data-v-e6011578=""
												class="product-badge">
												<img data-v-e6011578=""
												...
												<div data-v-e6011578="" class="product-info">
													<span data-v-e6011578="" class="artist-name"> 초은농장 </span>
													<span data-v-e6011578="" class="product-title">
														🏅무항생제 돼지 삼겹살🐷건강하게 먹자👍껍질쫀득식감 </span>
													<div data-v-e6011578="" class="product-price">
						...
						<div data-v-630eb5b4="" class="ScrollPaginationContainer">
							<div data-v-70d95496="" data-v-630eb5b4=""
