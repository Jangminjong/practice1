                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                     <c:forEach var="classOrder" items="${ClassOrderViewAll}" varStatus="i">
                                       <tr>
                                            <th scope="row">${total-((paging.nowPage-1)* 5)-i.index}</th>
                                            <td>
                                                <a href="classDetail.wdo?class_order_seq=${classOrder.class_order_seq}">${classOrder.class_order_id}</a>
                                            </td>                                            
                                            <td>${classOrder.class_order_name}</td>
                                            <td>${classOrder.class_order_people}</td>
                                            <td><fmt:formatDate value="${classOrder.class_order_date}" pattern="yyyy.MM.dd"/></td>
                                            <td><fmt:formatDate value="${classOrder.class_order_time}" pattern="a HH:mm"/></td>
								...
								<ul class="pagination justify-content-end">
									<c:choose>
										...
										<c:when test="${paging.nowPage ne 1 }">
											<li class="page-item"><a
												href="/mpweb/orderClass.wdo?nowPage=${paging.nowPage - 1 }&cntPerPage=${paging.cntPerPage}"
									...
									<c:forEach begin="${paging.startPage }"
										...
										<c:choose>
											<c:when test="${p eq paging.nowPage }">
												<li class="page-item"><a
													href="/mpweb/orderClass.wdo?nowPage=${p }&cntPerPage=${paging.cntPerPage}&set=${paging.set}"
									...
									<c:choose>
										...
										<c:when test="${paging.endPage ne paging.lastPage}">
											<li class="page-item"><a
												href="/mpweb/orderClass.wdo?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}&set=${paging.set}"
