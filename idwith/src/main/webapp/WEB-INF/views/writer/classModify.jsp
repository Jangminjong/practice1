                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="진행지역" required>
                                        <label class="form-label">지역</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="난이도" required>
                                        <label class="form-label">난이도</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="가능요일" required>
                                        <label class="form-label">수업 요일</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="수업 시간" required>
                                        <label class="form-label">수업 진행시간</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="인원" required>
                                        <label class="form-label">최대 참여 가능인원</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="description" cols="30" rows="5" class="form-control no-resize" required></textarea>
                                        <label class="form-label">개설된 날짜</label>
                                    </div>
                                </div>
                                ...
                                <button class="btn btn-primary waves-effect" type="submit">변경하기</button>
                            </form>
                        </div>
                    </div>
                </div>
