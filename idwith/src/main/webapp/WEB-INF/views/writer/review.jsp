                    ...
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered">
                                ...
                                <c:forEach var="writerReview" items="${writerReviewViewAll}" varStatus="i">
                                    <tr>
                                        ...
                                        <c:choose>
                                              <c:when test="${writerReview.goods_review_comment eq null }">
														<c:if test="${empty writerReview.goods_review_comment}">
															<td><span class="badge" style=width:70px;>답변 전 </span></td>
														</c:if>
														
											 </c:when>
											 <c:when test="${writerReview.goods_review_comment ne null }">
											 	<td><span class="badge bg-teal" style=width:70px;>답변완료</span></td>
											 </c:when>																		
									   </c:choose>
                                    </tr>
                                </c:forEach>
