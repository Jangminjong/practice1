								...
								<div class="row">
									...
									<div class="col-md-3">
										<label class="form-label">제목</label> <input type="text"
											class="form-control" placeholder="${adminQnA.board_title}"
											style="width: auto;" disabled>
									</div>
									<div class="col-md-3">
										<label class="form-label">작성자</label> <input type="text"
											class="form-control" placeholder="${adminQnA.user_id}"
											style="width: auto;" disabled>
									</div>
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<c:choose>
										<c:when test="${ adminQnA.board_answer eq null }">
											<textarea class="form-control" placeholder="답변내용" rows="5"
												name="board_answer"></textarea>
										</c:when>
										<c:when test="${ adminQnA.board_answer ne null }">
											<textarea class="form-control" placeholder="답변내용" rows="5"
												name="board_answer">${adminQnA.board_answer}</textarea>
										</c:when>
									</c:choose>
								</div>
								<c:choose>
