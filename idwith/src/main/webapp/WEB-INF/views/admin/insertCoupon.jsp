									...
									<form>
										...
										<div class="mb-3">
											...
											<input type="text" class="form-control" list="list" id="release"
												style="width: auto;" placeholder="user / seller" />
											<datalist id="list">
										...
										<div class="mb-3">
											...
											<input type="text" class="form-control" placeholder="최소 주문 금액"
												style="width: auto;">
										</div>
										<div class="mb-3">
											<label class="form-label">쿠폰 금액</label>
											<input type="text" class="form-control" placeholder="Coupon Price"
												style="width: auto;">
										</div>
										<div class="row">
											<div class="col-md-3">
												...
												<input type="text" class="form-control" placeholder="Start Date"
													style="width: auto;" id="startDate">
											</div>
											<div class="col-md-3">
												<label class="form-label">쿠폰 마감일</label>
												<input type="text" class="form-control" placeholder="End Date"
													style="width: auto;" id="endDate">
											</div>
