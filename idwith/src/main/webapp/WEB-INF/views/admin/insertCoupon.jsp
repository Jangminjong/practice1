						...
						<div class="container-fluid p-0">
							...
							<div class="card">
								<div class="card-body" style="width: auto;">
									<form id="form-admin-couponInsert" name="couponInsertForm" action="couponInsert.mdo" method="post" onsubmit="false">
										<div class="mb-3">
											<label class="form-label">쿠폰 이름</label>
											<input type="text" class="form-control" placeholder="Coupon Name" name="couponName" id="couponName"
												style="width: auto;">
										</div>
										<div class="mb-3">
											<label class="form-label">쿠폰 내용</label>
											<input type="text" class="form-control" placeholder="Coupon Name" name="couponContext" id="couponContext"
												style="width: 50%;">
										</div>
										<div class="mb-3">
											<label class="form-label" for="release">배포 대상</label>
											<input type="text" class="form-control" list="list" id="release" style="width: auto;" placeholder="user / seller" name="couponTarget" />
											<datalist id="list">
												<option>All</option>
										...
										<div class="mb-3">
											...
											<input type="text" class="form-control" placeholder="최소 주문 금액" name="couponCondition" id="couponCondition"
												style="width: auto;">
										</div>
										<div class="mb-3">
											<label class="form-label">쿠폰 금액</label>
											<input type="text" class="form-control" placeholder="Coupon Price" name="couponDiscount" id="couponDiscount"
												style="width: auto;">
										</div>
										<div class="row">
											<div class="col-md-3">
												<label class="form-label">쿠폰 마감일</label>
												<input type="date" class="form-control" placeholder="End Date" style="width: auto;" id="couponEnddate" name="couponEnddate">
											</div>
										</div>
										<div class="row">
